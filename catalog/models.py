...
class Movie(models.Model):
    ...
    # Foreign Key used because movie can only have one author, but authors can have multiple movies
...
class MovieInstance(models.Model):
    ...
    @property
    def is_overdue(self):
        """Determines if the movie is overdue based on due date and current date."""
